...
import { ShoppingCart, ArrowLeft, Star, Shield, Award, Gem, Pen } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

export default function PremiumPensPage() {
  ...
  const features = [
    {
      ...
      description: "Crafted from precious metals, exotic woods, and fine resins"
    },
    {
      icon: Award,
      title: "Expert Craftsmanship",
      description: "Handcrafted by master artisans with meticulous attention to detail"
    },
    {
      icon: Star,
      title: "Exclusive Collections",
      description: "Limited edition pieces from world-renowned pen manufacturers"
    }
  ];
    ...
    <div className="min-h-screen bg-linear-to-b from-background via-muted/20 to-background">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Discover our exquisite collection of luxury writing instruments. Each pen is a masterpiece 
              of craftsmanship, combining elegance, precision, and the art of fine writing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              What Makes Our Premium Pens Exceptional
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                <p className="text-lg">
                  Our premium pen collection features the world's most prestigious brands, 
                  each piece representing the pinnacle of writing instrument excellence.
                </p>
                <p className="text-lg">
                  From classic fountain pens to sophisticated rollerballs and ballpoints, every writing 
                  instrument in our collection has been carefully selected for its exceptional quality, 
                ...
                <ul className="space-y-2 mt-6">
                  ...
                  <li className="flex items-center">
                    <div className="w-2 h-2 rounded-full bg-primary mr-3" />
                    Complimentary engraving and maintenance services
                  </li>
                </ul>
              </div>
            </motion.div>
      ...
      <section className="py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Own a Writing Masterpiece?
            </h2>
